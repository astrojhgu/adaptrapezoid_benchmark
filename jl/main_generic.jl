...
struct Interval
    ...
    x2::AbstractFloat
    f2::AbstractFloat
    subsum::AbstractFloat
end

Interval(x1::AbstractFloat, f1::AbstractFloat, x2::AbstractFloat, f2::AbstractFloat)=Interval(x1, f1, x2, f2, (f1+f2)*(x2-x1)/2.0)
...
function try_split(func::Function, i::Interval, eps::AbstractFloat)::Tuple{Interval, Interval, Bool}
    (i1,i2)=split(func, i)
    return (i1,i2,abs(i1.subsum+i2.subsum-i.subsum)<eps)
end

function refine_iter(func::Function, unrefined::Deque{Interval}, refined::Deque{Interval}, eps::AbstractFloat, full_width::AbstractFloat)::Tuple{Deque{Interval}, Deque{Interval}}
...
function refine_until_converge(func::Function, initial_intervals::Deque{Interval}, eps::AbstractFloat, full_width::AbstractFloat)::Deque{Interval}
...
function integrate(func::Function, init_ticks, eps::AbstractFloat)::AbstractFloat
